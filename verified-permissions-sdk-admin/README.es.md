...
Cliente programático de Control Plane para Hodei Verified Permissions.

## Descripción General

El **SDK Admin de Hodei** (`verified-permissions-sdk-admin`) proporciona una biblioteca Rust de alto nivel para la gestión programática de recursos de Hodei Verified Permissions. Habilita operaciones completas de Control Plane incluyendo gestión de policy stores, esquemas y políticas.

Esta biblioteca es parte de la refactorización **Hodei SDK v0.2.0** que separa el Data Plane (verificación de autorización) del Control Plane (gestión de políticas) siguiendo las mejores prácticas de la industria.
