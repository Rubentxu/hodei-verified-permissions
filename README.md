...
```bash
# Run all working tests (130 tests in ~5 seconds)
make test-all
```

See the [Testing Guide](docs/TESTING.md) for complete documentation including:
- Unit, integration, container, and E2E test commands
