...
test.describe("Dashboard - Fase 3 Features", () => {
  ...
  test("should display dashboard with metrics", async ({ page }) => {
    ...
    await expect(
      page.locator("h3").filter({ hasText: "Policy Stores" }),
    ).toBeVisible();
    await expect(
      page.locator("h3").filter({ hasText: "Policies" }),
    ).toBeVisible();
    await expect(
      page.locator("h3").filter({ hasText: "Schemas" }),
    ).toBeVisible();
    await expect(
      page.locator("h3").filter({ hasText: "Templates" }),
    ).toBeVisible();
  });
  ...
  test("should display authorization request charts", async ({ page }) => {
    ...
    await expect(
      page.locator("text=Chart will be displayed here").first(),
    ).toBeVisible();
  });
  ...
  test("should display activity feed", async ({ page }) => {
    ...
    await expect(
      page.locator("h3").filter({ hasText: "Recent Activity" }),
    ).toBeVisible();
    ...
    const noActivityMessage = await page
